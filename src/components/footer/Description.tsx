...
export default function Description() {
  ...
  return (
    <div className="relative overflow-hidden">
      <h1 className="text-xl mb-5 text-neutral-600">
        <strong>فروشگاه اینترنتی دیجی‌کالا، بررسی، انتخاب و خرید آنلاین</strong>
      </h1>
      <div className="text-xs leading-7 text-gray-600">
        <p
          className={`relative after:absolute after:bg-gradient-to-t after:from-white after:to-white/50 after:w-full after:h-5 after:bottom-0 after:right-0 ${
            showMore ? "after:hidden" : "after:block"
          }`}
        >
        ...
        {showMore && (
          <>
            <p>
              ...
              خدمات دیجی‌کالا، این فروشگاه اینترنتی در بخشی از وب‌سایت خود
            ...
            <p>
              ...
              متنوع مثل انواع&nbsp;
              <span className="text-sky-500">لباسشویی اسنوا</span>، شیرآلات
            ...
            <p>
              ...
              <span className="text-sky-500">کتاب زبان</span>، بازی، لوازم تحریر
              با طرح‌های مختلف مانند{" "}
              <span className="text-sky-500">دختر کفشدوزکی</span>، سازهایی
              مثل&nbsp;
