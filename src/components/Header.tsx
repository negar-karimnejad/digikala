...
export default function Header() {
  return (
    <header className="border-b shadow-sm w-full sm:flex sm:justify-between pt-2">
      <Container>
        <div className="flex justify-between items-center">
          <div className="flex gap-2 w-[45rem]">
            ...
            <label
              htmlFor="search"
              className="w-full flex items-center bg-gray-100 border-0 rounded-lg"
            >
        ...
        <nav className="flex items-center justify-between pt-4">
          <div className="flex items-center">
            ...
            <button className="relative flex mx-3 py-3 items-center gap-1 text-gray-400 text-[13px] group">
  ...
  return (
    <>
      {links.map((link) => (
        <button
          key={link.label}
          className="relative flex mx-3 py-3 items-center gap-1 text-gray-400 text-[13px] group"
        >
          <span>{link.icon}</span>
