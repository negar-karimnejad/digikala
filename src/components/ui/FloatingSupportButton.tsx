  ...
  return (
    <div className="relative max-lg:hidden">
      <div className=" cursor-pointer bg-rose-500 w-12 h-12 flex items-center justify-center z-40 rounded-full fixed bottom-12 right-10">
        ...
        {isShowSupportModal && (
          <div className="absolute h-[28rem] bottom-12 w-96 right-0 border border-rose-600 bg-white rounded-xl overflow-hidden">
            ...
            <div className="h-96 overflow-y-auto">
              ...
              <Accordion type="single" collapsible className="w-full px-5">
                <AccordionItem
                  value={"item-1"}
                  className="border rounded-xl px-3 py-2 my-2"
                >
                  <AccordionTrigger className="text-[15px] text-right leading-6 hover:no-underline text-neutral-800">
                    چگونه میتوانم یک پروفایل ایجاد کنم؟
                  </AccordionTrigger>
                  <AccordionContent className="border-t text-sm text-neutral-600 pt-4 leading-7">
