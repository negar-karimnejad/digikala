    ...
    <>
      {user.address && (
        <div className="relative grid grid-cols-12 gap-3 px-4 lg:px-20">
                  ...
                  {cart.map((product) => (
                    ...
                    >
                      <div className="flex items-center flex-col">
                        ...
                        />
                        <p className="overflow-hidden w-full text-ellipsis whitespace-nowrap text-xs font-irsansb text-neutral-600 dark:text-neutral-100 p-4">
                          {product.title}
                        </p>
                      </div>
                    </div>
          ...
          <div
            className={`h-96 lg:col-span-3 col-span-12 sticky z-10 ${
          ...
          >
            <div className="lg:border rounded-lg lg:space-y-6 space-y-4 lg:p-6 pt-6">
              ...
              <Button className="py-2 font-irsansb w-full">ثبت سفارش</Button>
            </div>
          </div>
        </div>
      )}
